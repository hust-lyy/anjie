    ...
    $.fn.dialogbox = function ($options, $callback) {
        ...
        switch($settings['type']) {
            ...
            case 'error':
                ...
                $($id + ' .dialogbox-button-bar').html('').append('<div class="dialogbox-btn">知道了</div>');
                break;
            // Questions
            case 'yes/no':
                $($id + ' .dialogbox-prompt').hide();
                $($id + ' .dialogbox-button-bar').html('').append('<div class="dialogbox-btn">取消</div>').append(
                    '<div class="dialogbox-btn">确认</div>');
                break;
            case 'ok/cancel':
                $($id + ' .dialogbox-prompt').hide();
